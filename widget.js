...
cpdefine('inline:com-chilipeppr-widget-3dviewer', ['chilipeppr_ready', 'Three', 'ThreeTrackballControls', 'ThreeTween', 'ThreeProjector'], function () {
    ...
    return {
        ...
        gotoXyz: function(data) {
            ...
            if (this.animationLatencyTimer) {
                console.log("gotoXyz. skipping logic, animation already in progress");
                return;
            }
        ...
        gotoLine: function(data) {
            ...
            if (!curLine.p2) {
                console.log('no p2 defined for current line:', curLine);
                return;
            }
        ...
        drawAxes: function() {
            ...
            axes = new THREE.AxisHelper(this.getUnitVal(105));
        ...
        animate: function() {
            ...
            if ((this.moveAnimate || this.gotoAnimate || this.tweenAnimate || this.inspectAnimate) && this.animationLatencyTimer == null) {
            ...
            var parser = new this.GCodeParser({
                ...
                G2: function (args, indx, gcp) {
                    ...
                    if (args.clockwise === false) {
                        newLine.clockwise = args.clockwise;
                    }
